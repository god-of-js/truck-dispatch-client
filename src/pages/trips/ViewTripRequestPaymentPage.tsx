    ...
    return (
        <PageStyling>
            {pageLoading ? (
                ...
                <>
                    <MessageWithImage title="Payment request has been received" subtitle="We have received your payment request. We would validate your trip status and get back to you. It normally takes a couple minutes for it to be verified. To view the status of the payment, navigate to the transcations page or click the button below" />
