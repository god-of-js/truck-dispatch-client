            ...
            <>
              {paymentRequest.status === 'completed' ? (
                ...
                <>
                  ...
                  <p>
                    The responsible transporter claims he has loaded the cargo
                    and is ready to proceed with the trip. Kindly confirm the
                    loading before his payment is forwarded. <br /> PS: payment
                    is required before start of the trip to enable the
                    transporter overcome issues that may arise during the trip.
                  </p>
