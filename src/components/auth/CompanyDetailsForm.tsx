  ...
  return(
    <StyledAuthScreen>
      <div className="header-container" >
        ...
        <p>
          Please provide the correct company details.
        </p>
      </div>
            ...
            { 
              ...
              <>
                ...
                icon={<UiIcon icon="InfoCircle" size="17"/>}>
                  You have to be a registered company to register as a transport company on TruckDispatch. But you can always register as {alertMessage()} now, and upgrade when you have your documents
                </UiAlert>
              </> 
            }
            {
              ...
              <UiButton   size="large" variant="primary" isFullWidth>
                { formData.company_registered === 'No' ? `Continue as ${alternativeUserType()}` :  'Continue'}
              </UiButton>
            </>
          )}
        </UiForm>
